namespace MSD.Client.Forms
{
    partial class AboutBoxForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "Название продукта: Must Stay Dead!";
            ...
            this.labelVersion.Text = "Версия: 0.1 Beta";
            ...
            this.labelCopyright.Text = "Авторские права: (c) Daniel Momot";
            ...
            this.textBoxDescription.Text = "Описание: Данное приложение разработано в рамках экзаменационного проекта по пред" +
    "мету \"Технологии разработки ПО\". Выполнил студент 3 курса Даниэль Момот";
            // 
            // okButton
            // 
